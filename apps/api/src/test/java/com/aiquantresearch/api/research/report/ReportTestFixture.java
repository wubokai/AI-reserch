...
final class ReportTestFixture {
    ...
    ReportTestFixture() {
        ...
        quantResults = List.of(
                ...
                quant("rsi_14", "61.25", "INDEX_POINTS"),
                quant("atr_14", "4.75", "USD_PER_SHARE"),
                quant("distance_from_52_week_high", "-0.12", "RATIO"),
                quant("volume_moving_average_20", "1250000", "SHARES"),
