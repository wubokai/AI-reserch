...
| Phase 2：持久任务与状态机 | 终验中 | Flyway V1–V4、Research API、durable queue、lease/fencing/reaper、状态机、幂等、重试/取消/软删除、所有权、审计/outbox 与健康降级已实现；等待 GitHub Actions Gate G2 |
...
- 本机没有 Docker；Phase 2 容器/Testcontainers 验证由 GitHub Actions Linux runner 完成。
