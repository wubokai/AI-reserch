...
- 2026-07-12 完成 CoinGlass 风格浅色界面升级：统一白色/浅灰设计令牌，移除非必要卡片边框，以留白、柔和背景和轻量阴影建立层级；新增卡片/按钮/抽屉/进度/图表动效，并修正生产 Web 构建阶段的 REAL 数据模式标识；Web lint、TypeScript、41 个 Vitest、production build 与 5 个 Playwright 闭环测试通过；
